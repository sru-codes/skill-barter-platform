  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white overflow-x-hidden selection:bg-indigo-500/30 font-sans">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10 group">
         <div className="absolute top-[-10%] left-[-5%] w-[60%] h-[60%] bg-indigo-600/10 blur-[150px] rounded-full animate-pulse"></div>
        ...
        <div className="max-w-7xl w-full flex justify-between items-center bg-slate-950/40 backdrop-blur-2xl border border-slate-900 rounded-3xl h-16 px-8 shadow-2xl">
          <div className="flex items-center gap-3 cursor-pointer group" onClick={() => window.scrollTo(0, 0)}>
            ...
            <span className="text-xl font-black tracking-tighter uppercase italic leading-none">
              ...
              <span className="text-indigo-600">Barter</span>
            </span>
          </div>
          
          <div className="flex items-center gap-8">
            <div className="hidden lg:flex gap-10 text-[10px] font-black tracking-[0.4em] text-slate-500 italic">
               <a href="#how" className="hover:text-indigo-500 transition-colors">How it Works</a>
      ...
      <header className="relative pt-48 md:pt-64 pb-40 px-6">
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-3 px-5 py-2 mb-10 rounded-2xl bg-slate-900 border border-slate-800 shadow-2xl">
            <span className="text-indigo-500 font-black text-[9px] tracking-[0.4em] italic">Network Active</span>
          ...
          <h1 className="text-6xl md:text-9xl font-black mb-10 leading-[0.9] tracking-tighter text-white italic text-center">
             Exchange Skills, <br /> <span className="text-indigo-600 drop-shadow-[0_0_30px_rgba(79,70,229,0.3)]">Not Money.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <button 
              onClick={() => navigate("/login")}
              className="btn-primary px-16 h-20 text-sm flex items-center justify-center gap-4 font-black tracking-[0.3em] italic shadow-2xl shadow-indigo-600/40"
            >
      ...
      <section className="py-24 border-y border-slate-900 bg-slate-950 px-6">
         <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-12 lg:gap-20">
            {[
              ...
              { label: "Match Success", value: "99.8%", color: "text-indigo-600" },
      ...
      <section id="how" className="py-40 px-6 max-w-7xl mx-auto relative">
         ...
         <div className="text-center mb-32">
            <h2 className="text-5xl md:text-7xl font-black mb-6 tracking-tighter italic">How it <span className="text-indigo-600">Works.</span></h2>
         ...
         <div className="grid md:grid-cols-3 gap-10">
            {[
               ...
               <div key={idx} className="bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-[3rem] p-12 hover:border-indigo-600/50 transition-all group relative overflow-hidden shadow-2xl">
                  <div className="absolute -top-10 -right-10 w-32 h-32 bg-indigo-600/10 blur-3xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                  <div className="w-14 h-14 bg-indigo-600 rounded-2xl flex items-center justify-center text-[10px] font-black mb-10 text-white italic tracking-widest shadow-2xl shadow-indigo-600/30">
                     {step.n}
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-32 items-center">
             <div className="order-2 lg:order-1">
                <h2 className="text-5xl md:text-6xl font-black mb-16 leading-[1.1] tracking-tighter italic">Skill Barter <br /><span className="text-indigo-600">Benefits.</span></h2>
                <div className="space-y-12">
                   {features.map((f, i) => (
                     <div key={i} className="flex gap-8 group">
                        <div className={`w-16 h-16 shrink-0 rounded-[1.5rem] bg-slate-950 border border-slate-800 flex items-center justify-center text-indigo-500 transition-all group-hover:bg-indigo-600 group-hover:text-white group-hover:shadow-2xl group-hover:shadow-indigo-600/30`}>
             ...
             <div className="order-1 lg:order-2">
                <div className="bg-slate-950 border border-slate-900 rounded-[4rem] p-16 md:p-24 text-center relative overflow-hidden group shadow-inner">
                   <div className="absolute top-0 right-0 p-8">
                      <Sparkles className="text-indigo-500 opacity-20 group-hover:opacity-100 transition-opacity animate-pulse" size={60} />
                   </div>
                   <div className="w-40 h-40 bg-slate-900 rounded-[2.5rem] border border-slate-800 flex items-center justify-center mx-auto mb-12 shadow-2xl group-hover:scale-110 transition-transform duration-700">
                      <Brain size={72} className="text-indigo-600 animate-pulse" />
                   </div>
                   <p className="text-indigo-500 font-black text-[11px] tracking-[0.6em] mb-6 italic">COMMUNITY v2.0</p>
      ...
      <section className="py-48 px-6">
         <div className="max-w-5xl mx-auto bg-slate-900 border border-slate-800 rounded-[4rem] p-16 md:p-28 text-center relative overflow-hidden shadow-2xl">
            <div className="absolute top-[-10%] left-[-10%] w-[400px] h-[400px] bg-indigo-600/10 blur-[120px] rounded-full"></div>
            <div className="absolute bottom-[-10%] right-[-10%] w-[400px] h-[400px] bg-pink-600/5 blur-[120px] rounded-full"></div>
            
            <h2 className="text-5xl md:text-8xl font-black mb-10 leading-none tracking-tighter italic">Ready to <br /><span className="text-indigo-600">Connect?</span></h2>
            ...
            <button 
              onClick={() => navigate("/login")}
              className="btn-primary px-20 h-24 text-base font-black tracking-[0.4em] italic shadow-2xl shadow-indigo-600/40 hover:scale-105 active:scale-95 transition-all"
            >
              Connect Now
            </button>
         </div>
        ...
        <div className="max-w-7xl mx-auto">
           <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-16">
              ...
              <div className="flex flex-wrap gap-12 font-black text-[10px] tracking-[0.4em] text-slate-700 italic">
                 ...
                 <a href="#" className="hover:text-indigo-500 transition-colors">Updates</a>

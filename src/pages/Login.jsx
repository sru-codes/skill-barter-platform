  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6 relative overflow-hidden">
      <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
         <div className="absolute top-[5%] left-[5%] w-[600px] h-[600px] bg-blue-600/10 blur-[150px] rounded-full"></div>
      ...
      <div className="w-full max-w-4xl bg-slate-900 border border-slate-800 rounded-[2.5rem] overflow-hidden flex flex-col md:flex-row shadow-2xl animate-fade-in relative min-h-[500px]">
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-600 via-blue-500 to-pink-600 z-50"></div>
        ...
        <div className="hidden md:flex flex-col justify-between w-[40%] bg-slate-950 p-10 relative overflow-hidden border-r border-slate-800">
           <div className="absolute top-0 right-0 w-full h-full bg-blue-600/5 blur-[100px]"></div>
           <div className="relative z-10">
              ...
              <h2 className="text-4xl lg:text-5xl font-black text-white leading-tight mb-6 tracking-tighter italic">
                Exchange <br /> Skills, Not <br /> <span className="text-blue-600">Money.</span>
              </h2>
           ...
           <div className="relative z-10 space-y-8 pt-10 border-t border-slate-800">
              {[
                ...
                <div key={idx} className="flex items-center gap-3 group">
                   <div className="w-8 h-8 rounded-lg bg-slate-900 flex items-center justify-center border border-slate-800 text-blue-500 group-hover:bg-blue-600 group-hover:text-white transition-all shadow-inner">
                      <item.i size={14} />
                   </div>
                   <div>
        ...
        <div className="w-full md:w-[60%] p-8 md:p-12 flex flex-col justify-center bg-slate-900/50">
           {mode === "main" && (
             <div className="animate-fade-in text-center md:text-left">
                <h1 className="text-3xl font-black text-white mb-3">Welcome to <span className="text-blue-600">Skill Barter</span></h1>
                ...
                <div className="mt-12 pt-8 border-t border-slate-800">
                   ...
                   <button onClick={() => { setMode("email"); setIsRegister(false); }} className="text-blue-500 font-bold text-sm hover:text-white transition-all border-b border-blue-500/40 hover:border-white tracking-tighter">
                     Enter Skill Barter
                   </button>
                </div>
             </div>
           ...
           {mode === "email" && (
             <div className="animate-fade-in">
                <button onClick={() => setMode("main")} className="flex items-center gap-2 text-blue-500 font-bold text-sm mb-10 hover:text-white transition-all italic">
                ...
                <div className="space-y-4">
                   ...
                   {!isRegister && (
                     <div className="flex justify-end -mt-2">
                       <button onClick={handleForgotPassword} className="text-blue-500 text-[10px] font-bold hover:text-white transition-colors italic">
                         Forgot Password?
                       </button>
                     </div>
                   )}

                   <button onClick={handleEmail} disabled={loading} className="w-full btn-primary h-12 text-xs font-black tracking-widest italic shadow-xl shadow-blue-600/30 disabled:opacity-50 mt-4">
           ...
           {mode === "phone" && (
              <div className="animate-fade-in">
                <button onClick={() => { setMode("main"); resetPhone(); }} className="flex items-center gap-2 text-blue-500 font-bold text-sm mb-10 hover:text-white transition-all italic"><ArrowLeft size={16} /> Back</button>
                ...
                {!otpSent ? (
                  <div className="space-y-6">
                     <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="h-14 px-4 bg-slate-950 border border-slate-800 rounded-xl flex items-center text-blue-400 font-bold text-sm shrink-0">+91</span>
                     ...
                     <button onClick={sendOTP} disabled={loading || phone.replace(/[^\d]/g, "").length !== 10} className="w-full btn-primary h-14 text-sm font-black tracking-widest italic shadow-xl shadow-blue-600/30 disabled:opacity-50 disabled:cursor-not-allowed">
                  ...
                  <div className="space-y-6">
                     ...
                     <div className="space-y-3 text-center">
                        ...
                        <input type="text" inputMode="numeric" maxLength={6} value={otp} onChange={e => setOtp(e.target.value.replace(/\D/g, ""))} placeholder="000000" className="w-full bg-slate-950 border border-slate-800 rounded-2xl px-6 py-6 text-white focus:outline-none focus:border-blue-600 transition-all font-black text-3xl text-center tracking-[0.4em] shadow-inner" />
                     </div>
                     <button onClick={verifyOTP} disabled={loading || otp.length < 6} className="w-full btn-primary h-14 text-sm font-black tracking-widest italic shadow-xl shadow-blue-600/40 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed">
